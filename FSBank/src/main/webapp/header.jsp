  ...
  <body>
    ...
    <div class="w3-top">
      <div class="w3-bar w3-theme-d2 w3-left-align">
        ...
        <a href="index.jsp#team" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Team</a>
        <a href="index.jsp#work" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Work</a>
